...
- 🌐 **Frontend Developer:** Building responsive, user-friendly interfaces with **React**, **JavaScript**, **TypeScript** and **CSS**.  
- 🤖 **Automation & AI Enthusiast:** Streamlining workflows with **RPA tools** and **AI-driven models**, optimizing business operations.  
